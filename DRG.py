...
#Creates and configures an outer frame (border)
...
#Creates and configures an inner frame (content area)
inner_frame = tk.Frame(outer_frame, bg='#CC0066')  
inner_frame.pack(padx=5, pady=5, expand=True, fill=tk.BOTH)

#Sets the column weights for centering the buttons
for col in range(12):
    inner_frame.grid_columnconfigure(col, weight=1)

#Sets the row weights for centering the buttons vertically
inner_frame.grid_rowconfigure(1, weight=1)

#Creates and configures widgets within the frame
